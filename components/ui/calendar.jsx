...
function Calendar({
  ...
  return (
    (<DayPicker
      ...
      classNames={{
        months: "flex w-fit flex-col  sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        ...
        day_selected:
          "bg-blue-500 rounded-none text-slate-50 hover:bg-blue-900 hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50 dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50 dark:hover:text-slate-900 dark:focus:bg-slate-50 dark:focus:text-slate-900",
        ...
        day_disabled: "text-slate-900 opacity-50 dark:text-slate-400",
        day_range_middle:
