    ...
    <>
        ...
        <Carousel
          ...
          <CarouselContent className="">
            {information?.map(({ randomDate, update }) => (
              <CarouselItem key={update} className='ml-2 hover:scale-110 transition-all delay-100 '>
                <Card className="">
      ...
      <Carousel
        ...
        <CarouselContent className="-mt-0 h-[200px] ">
          {information?.map(({ randomDate, update }) => (
            <CarouselItem key={update} className='hover:scale-110 transition-all delay-100'>
              <Card className="">
