...
export const verifySession = async (request) => {
  ...
  console.log('verifySession - request.url:', request.url)
  console.log('verifySession - request.nextUrl is:', request.nextUrl)
  if (!session?.userID) {
    console.log('verifySession - redirecting to request.url:', request.url)
